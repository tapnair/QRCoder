...
try:
    ...
    my_addin.add_command(
        ...
        SamplePaletteShowCommand,
        {
            ...
            'palette_html_file_url': os.path.join('commands', 'palette_html', 'QRCoder.html'),
    ...
    # my_addin.add_custom_event("QRCoder_message_system", SampleCustomEvent)
    # my_addin.add_document_event("QRCoder_open_event", app.documentActivated, SampleDocumentEvent1)
    # my_addin.add_document_event("QRCoder_close_event", app.documentClosed, SampleDocumentEvent2)
    # my_addin.add_workspace_event("QRCoder_workspace_event", ui.workspaceActivated, SampleWorkspaceEvent)
    # my_addin.add_web_request_event("QRCoder_web_request_event", app.openedFromURL, SampleWebRequestOpened)
    # my_addin.add_command_event("QRCoder_command_event", app.userInterface.commandStarting, SampleCommandEvent)
    # my_addin.add_command_event("QRCoder_active_selection_event", ui.activeSelectionChanged, SampleActiveSelectionEvent)
